            ...
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    ...
                    <div class="p-6 bg-white shadow-sm sm:rounded-lg">
                        ...
                        <div class="mt-4">
                            <x-text-input wire:model.live.debounce.300ms="search"
                                wire:keydown.enter.prevent="scanOrSearch" type="text" class="w-full"
                                placeholder="Cari nama obat atau scan barcode..." autofocus />
                        </div>
                        ...
                        @endif
                        <div class="mt-4 h-96 overflow-y-auto border rounded-md">
                            <table class="min-w-full divide-y divide-gray-200">
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @forelse ($medicines as $medicine)
                                        <tr wire:click="addToCart({{ $medicine->id }})"
                ...
                <div class="lg:col-span-1">
                    <div class="p-6 bg-white shadow-sm sm:rounded-lg">
                        ...
                        <div class="mt-4 border-t border-b divide-y h-80 overflow-y-auto">
                                ...
                                <div class="flex items-center justify-between p-4">
                                    ...
                                    <div class="flex items-center">
                                        <button wire:click="decrementQuantity({{ $id }})"
                                            class="px-2 py-1 text-lg font-bold text-gray-600 bg-gray-200 rounded-l">-</button>
                                        <span class="px-4 py-1 bg-white">{{ $item['quantity'] }}</span>
                                        <button wire:click="incrementQuantity({{ $id }})"
                                            class="px-2 py-1 text-lg font-bold text-gray-600 bg-gray-200 rounded-r">+</button>
                        ...
                        <div class="pt-4 mt-4 border-t">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <x-text-input type="number" wire:model.live="paid_amount" class="w-32 text-right"
                                        placeholder="0" />
                                </div>
                                <div class="flex justify-between font-semibold">
                                    <span>Kembalian</span>
                            ...
                            <div class="mt-4">
                                <x-primary-button wire:click="processTransaction" class="w-full text-center"
                                    :disabled="empty($cart) || $paid_amount < $total">
