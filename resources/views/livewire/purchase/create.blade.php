                        ...
                        <table class="min-w-full bg-white">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b">
                                    ...
                                    <td>
                                        <x-text-input type="number" wire:model.live="purchaseList.{{ $id }}.purchase_price" class="w-32 text-sm" />
                                    </td>
                                    <td>
                                        <x-text-input type="number" wire:model.live="purchaseList.{{ $id }}.quantity" class="w-20 text-sm" />
                                    </td>
                                    ...
                                    <td class="px-4 py-2 text-center">
                                        <button wire:click="removeFromList({{ $id }})" class="text-red-500 hover:text-red-700">Hapus</button>
                                    </td>
                                </tr>
                                @empty
                                <tr>
